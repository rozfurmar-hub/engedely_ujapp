...
# HU/RU i18n + RU latin-írás figyelmeztetés + automatikus transzliteráció + (két mező RU->HU fordítás)
...
HU = {
    ...
    "ru_latin_notice": "⚠️ Orosz nyelvű felület esetén kérjük *latin* betűkkel (A–Z, 0–9) kitölteni. A cirill szövegeket automatikusan latinra írjuk át, kivéve a *Szakképzettség* és a *Magyarországra érkezést megelőző foglalkozás* mezőket, amelyeket magyarra fordítunk.",
    ...
    "elozo_kozterulet": "(Érkezés előtti) Közterület neve",
...
RU = {
    **HU,
    ...
    "ru_latin_notice": "⚠️ Пожалуйста, заполняйте *латиницей* (A–Z, 0–9). Текст кириллицей будет автоматически транслитерирован, кроме полей *Профессиональная квалификация* и *Профессия до приезда в Венгрию* — их переведём на венгерский.",
    "help_md": (
...
if submitted:
    ...
    if ui_lang == "ru":
        ...
        to_trans = [
            ...
            "egeszseg_egyeb","visszaut_orszag","kozlekedesi_eszkoz","fedezet_osszeg","elozo_orszag",
            "elozo_telepules","elozo_kozterulet","mas_schengen_tipus","mas_schengen_szam","buntet_reszletek",
            "tranzakcio_szam"
        ]
